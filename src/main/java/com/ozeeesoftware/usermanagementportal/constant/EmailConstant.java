...
public class EmailConstant {
    ...
    public static final String USERNAME = "yourmail@gmail.com";
    public static final String PASSWORD = "yourpassword";
    public static final String FROM_EMAIL = "support@ozeeesoftware.com";
    public static final String CC_EMAIL = "";
    public static final String EMAIL_SUBJECT = "Ozeee Software, LLC - New Password";
